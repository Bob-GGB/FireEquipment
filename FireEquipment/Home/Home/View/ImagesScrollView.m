...
//            [imageView setBackgroundColor:KRGB(arc4random_uniform(256), arc4random_uniform(256), arc4random_uniform(256), 1.0)];
//            imageView.contentMode = UIViewContentModeScaleAspectFill;
            [imageView sd_setImageWithURL:[NSURL URLWithString:images[i]] placeholderImage:[UIImage imageNamed:images[i]]];
            imageView.tag = i;
