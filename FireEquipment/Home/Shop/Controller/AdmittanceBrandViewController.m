//
//  AdmittanceBrandViewController.m
//  FireEquipment
//
...
#import "LGUIView.h"
@interface AdmittanceBrandViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation AdmittanceBrandViewController


-(void)viewWillAppear:(BOOL)animated{
    
    [super viewWillAppear:animated];
     [self postToSeVerGetBrandDataWithURL:@"http://equipmentapp.qianchengwl.cn/api/show/getBrand"];
}
...
-(void)creatNavHeadView{
    ...
    UIView *alView=[[UIView alloc] initWithFrame:CGRectMake(0,Is_Iphone_X ?44.f : 20.f, kScreenWidth, NaviHeight- (Is_Iphone_X ?44.f : 20.f))];
    ...
    for (int i=0; i<2; i++) {
        ...
        btn.frame=CGRectMake((kScreenWidth*0.75-Wisth-20)*i+10,0, Wisth, 40);//kScreenWidth*0.75是侧滑之后View的宽度
...
-(void)postToSeVerGetBrandDataWithURL:(NSString *)URL{
    ...
    [dict setValue:@(self.sellerIDNum) forKey:@"sellerID"];
